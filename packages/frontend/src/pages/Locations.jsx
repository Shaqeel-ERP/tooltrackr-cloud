    ...
    <ErrorBoundary>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {(locations || []).map(loc => (
            <div key={loc.id} className="bg-background rounded-xl shadow-sm border border-border overflow-hidden flex flex-col hover:shadow-md transition-shadow">
               <div className="p-5 border-b border-border flex-1">
                 ...
                 {loc.address && (
                   <div className="flex items-start gap-2 text-sm text-muted-foreground mb-4 mt-3">
                 ...
                 {loc.manager_name && (
                   <div className="flex flex-col gap-1 text-sm bg-slate-50/50 p-3 rounded-lg border border-border">
               ...
               <div className="bg-slate-50/50 p-5 pt-4">
                 ...
                 <Button className="w-full bg-background text-slate-700 hover:bg-muted border border-border shadow-sm" onClick={() => navigate(`/locations/${loc.id}`)}>
                    View Details
                 </Button>
               </div>
            </div>
