        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pt-2">
          <div className="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-lg">
            <div>
              ...
              <p className="text-3xl font-bold text-slate-900">{currentStock || 0}</p>
            </div>
            <div className="text-right">
              ...
              {diff > 0 ? (
                ...
                <span className="inline-flex items-center text-slate-500 font-medium bg-slate-100 px-2 py-1 rounded">
                  No change
                </span>
              )}
            </div>
